...
instructors["two"] = "2"
instructors["three"] = "3"
print(instructors["one"]!)
print(instructors["two"])
if instructors["two"] != nil {
    print(instructors["two"])
}
var track = [String: [String]]()
track["intro"] = ["one 1", "two 2", "three 3"]
track["apps"] = ["four 4", "five 5"]
track["games"] = ["six 6", "seven 7"]

if let intro = track["intro"] {
    print(intro)
}
