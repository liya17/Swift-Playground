...
//2
func perimiter(height: Int, width: Int)-> Int {
...
var array = [10, 30, 13, 5, 9]
print(perimiter(array))

//4

var instructors = ["one", "two", "three"]
func instructors(prefix: String) -> [String]?{
    var found = [String]()
    for instructor in instructors {
        if instructor.hasPrefix(prefix) {
            found.append(instructor)
        }
    }
    return found
}
